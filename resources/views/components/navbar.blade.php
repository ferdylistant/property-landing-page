<nav id="navbar" class="fixed w-full z-50 transition-all duration-300 text-white bg-transparent">
    <div class="container mx-auto flex justify-between items-center py-4 px-6">
        ...
        <ul class="hidden md:flex space-x-8 font-medium">
            <li><a href="#home" class="hover:text-emerald-400">Beranda</a></li>
            <li><a href="#properties" class="hover:text-emerald-400">Properti</a></li>
            <li><a href="#testimonials" class="hover:text-emerald-400">Testimoni</a></li>
        ...
        <div class="md:hidden">
            <button id="menu-toggle"
                class="relative inline-flex items-center justify-center rounded-md p-2 text-white hover:text-emerald-400">
    ...
    <div id="mobile-menu" class="hidden md:hidden px-6 pb-4 space-y-2">
        <a href="#home" class="block py-2 hover:text-emerald-400">Beranda</a>
        <a href="#properties" class="block py-2 hover:text-emerald-400">Properti</a>
        <a href="#testimonials" class="block py-2 hover:text-emerald-400">Testimoni</a>
        <a href="#contact" class="block py-2 hover:text-emerald-400">Kontak</a>
    </div>
</nav>
