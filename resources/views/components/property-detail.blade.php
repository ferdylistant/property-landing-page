...
<div class="grid md:grid-cols-2 gap-10">
    ...
    <div>
        <h1 class="text-4xl font-bold text-emerald-600 mb-4">{{ $title }}</h1>
        <p class="text-xl font-semibold text-gray-800 mb-4 flex items-center gap-1">
            <x-heroicon-o-currency-dollar class="w-6 h-6 text-emerald-600" /> {{ $price }}
        </p>
        ...
        <a href="https://wa.me/6281234567890?text=Halo,%20saya%20tertarik%20dengan%20{{ urlencode($title) }}"
            class="bg-emerald-600 text-white px-6 py-3 rounded-lg shadow hover:bg-emerald-700 inline-flex items-center gap-2">
