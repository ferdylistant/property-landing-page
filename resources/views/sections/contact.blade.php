<section id="contact" class="relative py-20 bg-gradient-to-r from-green-600 to-emerald-500 text-white overflow-hidden">
    ...
    <div class="container mx-auto px-6 relative z-10 grid md:grid-cols-2 gap-10 items-center">
        <!-- Text content -->
        <div class="text-center md:text-left">
            <h2 class="text-3xl md:text-4xl font-bold mb-6 flex items-center justify-center md:justify-start gap-2">
                <x-heroicon-o-phone-arrow-up-right class="w-8 h-8 text-white" />
                Siap Investasi atau Sewa Villa?
            </h2>
            <p class="mb-8 text-lg opacity-90">
                Hubungi tim kami untuk konsultasi gratis dan temukan properti impian Anda.
            </p>
            <a href="https://wa.me/6281234567890"
                class="bg-white text-green-700 px-6 py-3 rounded-2xl shadow-lg hover:bg-gray-100 transition font-semibold inline-flex items-center gap-2">
                <x-heroicon-o-chat-bubble-left-right class="w-5 h-5" /> Hubungi via WhatsApp
            </a>
        </div>
        ...
        <div class="flex justify-center md:justify-end">
            ...
            <svg id="villa-day" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 300"
                ...
                <rect x="130" y="140" width="140" height="90" fill="#fff" stroke="#e5e7eb" stroke-width="2"
                    rx="6" />
                <!-- Roof -->
                <polygon points="120,140 200,90 280,140" fill="#ef4444" />
                <!-- Door -->
                <rect x="185" y="180" width="30" height="50" fill="#6b7280" rx="3" />
                <!-- Windows -->
            ...
            <svg id="villa-night" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 300"
                ...
                <circle cx="335" cy="50" r="25" fill="#111827" /> <!-- bayangan bulan -->
                <!-- Bintang -->
                ...
                <rect x="130" y="140" width="140" height="90" fill="#1F2937" stroke="#374151" stroke-width="2"
                    rx="6" />
                <!-- Roof -->
                <polygon points="120,140 200,90 280,140" fill="#6B7280" />
                <!-- Door -->
