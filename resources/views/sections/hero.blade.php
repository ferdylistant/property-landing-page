<section id="home" class="relative h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="absolute inset-0 bg-gradient-to-r from-green-900/70 via-black/60 to-green-900/70"></div>
    ...
    <div class="relative z-10 text-center text-white max-w-2xl px-6">
        <h1 class="text-4xl md:text-6xl font-bold leading-tight">
            ...
            <span data-aos="fade-down" data-aos-delay="600"><span class="text-green-400">Terbaik</span> di
                Indonesia</span>
        </h1>
        <p class="mt-4 text-lg text-gray-200" data-aos="fade-up" data-aos-delay="800">
        ...
        <div class="mt-6 flex flex-col md:flex-row justify-center gap-4" data-aos="fade-up" data-aos-delay="1000">
            <a href="#properties"
                class="bg-green-600 text-white px-6 py-3 rounded-lg shadow hover:bg-green-700 flex items-center gap-2">
                <x-heroicon-o-eye class="w-5 h-5" /> Lihat Properti
            </a>
            <a href="#contact"
                class="bg-white border border-green-600 text-green-600 px-6 py-3 rounded-lg hover:bg-green-50 flex items-center gap-2">
